        ...
        @can('fn_b_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/tables*") ? "c-show" : "" }} {{ request()->is("admin/bookings*") ? "c-show" : "" }} {{ request()->is("admin/prices*") ? "c-show" : "" }} {{ request()->is("admin/products*") ? "c-show" : "" }}">
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    ...
                    @can('dataform_access')
                    <li class="c-sidebar-nav-item">
                        <a href="{{ route('admin.dataforms.index') }}" class="c-sidebar-nav-link {{ request()->is('admin/dataforms') || request()->is('admin/dataforms/*') ? 'c-active' : '' }}">                                
                            <i class="fa fa-address-book c-sidebar-nav-icon"></i>
                            {{ trans('cruds.dataform.title') }}
                        </a>
                    </li>
                @endcan
                </ul>
