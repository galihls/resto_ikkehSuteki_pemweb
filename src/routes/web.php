...
// use App\Http\Controllers\Admin\AdminDataFormController;
// use App\Http\Controllers\Admin\DataFormController;

Route::get ('/', 'frontend@index')->name('home');
Route::post ('/store', 'frontend@store')->name('store');
Route::post('/check-table-availability', [App\Http\Controllers\frontend::class, 'checkTableAvailability']);
...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth']], function () {
    ...
    // Data Form
    Route::get('dataforms', 'DataFormController@index')->name('dataforms.index');
